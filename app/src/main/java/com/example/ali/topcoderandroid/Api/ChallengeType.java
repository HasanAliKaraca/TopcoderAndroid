...
public enum ChallengeType {
    ...
    private static final Map<Integer, ChallengeType> challeTypeMap = new HashMap<>();
    ...
    public static ChallengeType getChallengeType(int challeTypeValue) {
        ChallengeType type = challeTypeMap.get(challeTypeValue);
      /*  if (type == null)
    ...
    public static ChallengeType getPreferred(Context context) {
