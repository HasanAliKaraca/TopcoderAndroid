...
public class RecyclerItemClickListener implements RecyclerView.OnItemTouchListener {
    ...
    public boolean onInterceptTouchEvent(RecyclerView view, MotionEvent event) {
        ...
        childViewPosition = view.getChildLayoutPosition(childView); //todo: not sure. It should be view.getChildAdapterPosition(childView)

        /*int childPosition = view.getChildAdapterPosition(childView);
        ChallengeRecyclerViewAdapter adapter = (ChallengeRecyclerViewAdapter) view.getAdapter();
